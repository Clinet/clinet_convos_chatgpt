module github.com/Clinet/clinet_convos_chatgpt
...
require (
	...
	github.com/m1guelpf/chatgpt-telegram v0.0.0-20221206205205-8326b88d80ec
)

require (
	github.com/Clinet/clinet_cmds v0.0.0-20221115092138-c7bae8607d0b // indirect
